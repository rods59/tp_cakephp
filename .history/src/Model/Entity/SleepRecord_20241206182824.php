...
// In src/Model/Entity/SleepRecord.php
    ...
    {
        $bedtime = new \DateTime((string)$this->bedtime);
        $wakeupTime = new \DateTime((string)$this->wakeup_time);
    ...
    {
        $interval = (new \DateTime((string)$this->wakeup_time))->diff(new \DateTime((string)$this->bedtime));
