...
$interval = (new \DateTime($bedtime->i18nFormat('yyyy-MM-dd HH:mm:ss')))->diff(new \DateTime($wakeupTime->i18nFormat('yyyy-MM-dd HH:mm:ss')));        $hours = $interval->h + ($interval->i / 60);
