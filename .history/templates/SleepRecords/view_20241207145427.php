...
// Assurez-vous que les heures de coucher et de réveil sont en format 24 heures
$bedtime = $sleepRecord->bedtime->format('H:i');
$wakeupTime = $sleepRecord->wakeup_time->format('H:i');

$sleepCycleTranches = calculateSleepCycleTranches($bedtime, $wakeupTime);
?>
