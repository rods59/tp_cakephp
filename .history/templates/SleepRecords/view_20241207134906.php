        ...
        <div class="sleepRecords view content">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <ul>
                            <?php if (!empty($sleepRecord->sleep_cycle_tranches) && is_array($sleepRecord->sleep_cycle_tranches)): ?>
                                <?php foreach ($sleepRecord->sleep_cycle_tranches as $index => $tranche): ?>
                                    <li><?= h($tranche) ?> (Cycle <?= $index + 1 ?>: 1h30)</li>
                                <?php endforeach; ?>
                            <?php else: ?>
