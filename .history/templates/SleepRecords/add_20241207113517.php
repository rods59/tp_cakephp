        ...
        <div class="sleepRecords form content">
            ...
            <fieldset>
                ...
                <?php
                    ...
                    <?= $this->Form->control('nap_evening', ['type' => 'checkbox', 'label' => 'Sieste le soir']) ?>     <?= $this->Form->control('mood', ['type' => 'select', 'options' => range(0, 10), 'label' => 'Humeur au réveil']) ?> <!-- Changed from morning_feeling to mood -->
