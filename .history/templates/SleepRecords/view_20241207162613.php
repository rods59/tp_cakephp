...
$sleepData = $sleepRecord->sleep_cycles_and_indicator;
$sleepCycleTranches = $sleepRecord->sleep_cycle_tranches;
?>
        ...
        <div class="sleepRecords view content">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><?= $sleepData['cycles'] ?></td>
                </tr>
                <tr>
                    <th><?= __('Cycle Indicator') ?></th>
                    <td><span style="color: <?= $sleepData['indicator'] ?>;">●</span></td>
                </tr>
                <tr>
                    <th><?= __('Sleep Cycle Tranches') ?></th>
                    <td>
                        <ul>
                            <?php foreach ($sleepCycleTranches as $tranches): ?>
                                <li><?= h($tranches) ?></li>
                            <?php endforeach; ?>
                        </ul>
                    </td>
